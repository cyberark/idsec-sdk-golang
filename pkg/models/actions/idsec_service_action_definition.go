...
type IdsecServiceBaseTerraformActionDefinition struct {
	...
	ComputedAttributes               []string    `mapstructure:"computed_attributes,omitempty" json:"computed_attributes,omitempty" desc:"Used to set attributes as computed-only (read-only) in the schema, preventing user input"`
}
