...
type IdsecIdentityUpdateRole struct {
	...
	DynamicRoleScript string   `json:"dynamic_role_script,omitempty" mapstructure:"dynamic_role_script" flag:"dynamic-role-script" desc:"Script for dynamic role for role types of Script"`
}
