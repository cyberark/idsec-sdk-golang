...
type IdsecIdentityRoleMember struct {
	RoleID     string `json:"role_id" mapstructure:"role_id" flag:"role-id" desc:"ID of the role" required:"true"`
	...
	MemberType string `json:"member_type" mapstructure:"member_type" flag:"member-type" desc:"Type of the member" choices:"USER,GROUP,ROLE" required:"true"`
}
