...
type IdsecIdentityUser struct {
	...
	Password                *string           `json:"password,omitempty" mapstructure:"password" flag:"password" desc:"Password of the user" secret:"true"`
	...
	ForcePasswordChangeNext *bool             `json:"force_password_change_next,omitempty" mapstructure:"force_password_change_next" desc:"Whether to force password change on next login"`
	PasswordNeverExpire     *bool             `json:"password_never_expire,omitempty" mapstructure:"password_never_expire" desc:"Whether the user password never expires"`
	InSysAdminRole          *bool             `json:"in_sysadmin_role,omitempty" mapstructure:"in_sysadmin_role" desc:"Whether the user is in the SysAdmin role"`
}
