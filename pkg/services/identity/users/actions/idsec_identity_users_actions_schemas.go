...
var ActionToSchemaMap = map[string]interface{}{
	...
	"user-info":                     nil,
	"users-stats":                   nil,
	"user-attributes-schema":        nil,
	"upsert-user-attributes-schema": &usersmodels.IdsecIdentityUpsertUserAttributesSchema{},
	"delete-user-attributes-schema": &usersmodels.IdsecIdentityDeleteUserAttributesSchema{},
	"user-attributes":               &usersmodels.IdsecIdentityGetUserAttributes{},
	"upsert-user-attributes":        &usersmodels.IdsecIdentityUpsertUserAttributes{},
	"delete-user-attributes":        &usersmodels.IdsecIdentityDeleteUserAttributes{},
}
