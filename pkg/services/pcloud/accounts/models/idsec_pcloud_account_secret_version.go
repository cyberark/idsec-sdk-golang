...
type IdsecPCloudAccountSecretVersion struct {
	...
	ModificationDate int    `json:"modification_date" mapstructure:"modification_date" desc:"Date and time the secret was rotated" flag:"modification-date"`
	ModifiedBy       string `json:"modified_by" mapstructure:"modified_by" desc:"User who rotated the secret" flag:"modified-by"`
