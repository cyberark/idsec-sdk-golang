...
type IdsecPCloudAddSafe struct {
	...
	NumberOfDaysRetention     *int   `json:"number_of_days_retention,omitempty" mapstructure:"number_of_days_retention,omitempty" desc:"The number of days that secrets versions are saved in the Safe" flag:"number-of-days-retention" validate:"min=0,max=3650"`
