...
type IdsecPCloudUpdateSafeMember struct {
	...
	MembershipExpirationDate int                               `json:"membership_expiration_date,omitempty" mapstructure:"membership_expiration_date,omitempty" desc:"User's Safe membership expiration date to be updated" flag:"membership-expiration-date" validate:"min=0"`
