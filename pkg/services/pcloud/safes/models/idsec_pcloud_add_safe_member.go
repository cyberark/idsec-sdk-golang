...
type IdsecPCloudAddSafeMember struct {
	...
	MembershipExpirationDate int                               `json:"membership_expiration_date,omitempty" mapstructure:"membership_expiration_date,omitempty" desc:"The member's expiration date for this Safe. For members with no expiration date, this value is null" flag:"membership-expiration-date" validate:"min=0"`
