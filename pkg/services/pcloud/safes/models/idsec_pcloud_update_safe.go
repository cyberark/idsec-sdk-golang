...
type IdsecPCloudUpdateSafe struct {
	...
	SafeName                  string `json:"safe_name,omitempty" mapstructure:"safe_name,omitempty" desc:"The unique name of the Safe. Do not enter special characters: \\ / : * < > . | ? “% & +" flag:"safe-name" maxlength:"28"`
