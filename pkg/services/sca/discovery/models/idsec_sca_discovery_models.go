...
// request, response and account info types.
package models
...
type IdsecSCADiscoveryRequest struct {
	...
	AccountInfo    IdsecSCADiscoveryAccountInfo `json:"account_info" mapstructure:"account_info" validate:"required" flag:"account-info" desc:"A map of key-value pairs containing the account information of the workspace to discover"`
}
