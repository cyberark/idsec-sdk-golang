...
type IdsecSecHubSecretsStats struct {
	...
	SecretsCountSyncedByCyberArk    int            `json:"secrets_count_synced_by_cyberark" mapstructure:"secrets_count_synced_by_cyberark" desc:"Secrets count for secrets synced by Idira"`
	SecretsCountNotSyncedByCyberArk int            `json:"secrets_count_not_synced_by_cyberark" mapstructure:"secrets_count_not_synced_by_cyberark" desc:"Secrets count for secrets not synced by Idira"`
}
