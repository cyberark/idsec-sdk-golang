...
type IdsecSecHubSyncPoliciesStats struct {
	...
	SyncPoliciesCountByCreator map[string]int `json:"sync_policies_count_by_creator" mapstructure:"sync_policies_count_by_creator" desc:"Sync Policies count by creator"`
}
