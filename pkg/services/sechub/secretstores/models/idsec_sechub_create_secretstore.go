...
type IdsecSecHubCreateSecretStore struct {
	Type        string                     `json:"type" mapstructure:"type" flag:"type" validate:"required" desc:"The type for the secrets (AWS_ASM,AZURE_AKV,GCP_GSM,HASHICORP_VAULT,HASHICORP_VAULT_ENT,PAM_PCLOUD,PAM_SELF_HOSTED)" choices:"AWS_ASM,AZURE_AKV,GCP_GSM,HASHICORP_VAULT,HASHICORP_VAULT_ENT,PAM_PCLOUD,PAM_SELF_HOSTED"`
