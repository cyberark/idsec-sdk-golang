...
type IdsecSecHubSecretStoreGcpAuthentication struct {
	...
	AuthenticationMethod      string `json:"authentication_method,omitempty" mapstructure:"authentication_method,omitempty" flag:"gcp-authentication-method" desc:"GCP: GCP authentication method to use" default:"GLOBAL_ROLE_EXTERNAL_ID" choices:"TENANT_ROLE,GLOBAL_ROLE_EXTERNAL_ID"`
}
