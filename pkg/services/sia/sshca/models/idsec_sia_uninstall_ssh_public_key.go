...
// IdsecSIAUninstallSSHPublicKey is a struct that represents the parameters needed to uninstall an SSH Public Key from a target machine.
type IdsecSIAUninstallSSHPublicKey struct {
	...
	Password           string `json:"password,omitempty" mapstructure:"password" flag:"password" desc:"The password to use to connect to the target machine via SSH." secret:"true"`
	...
	PrivateKeyContents string `json:"private_key_contents,omitempty" mapstructure:"private_key_contents" flag:"private-key-contents" desc:"The private key contents to use to connect to the target machine via SSH." secret:"true"`
