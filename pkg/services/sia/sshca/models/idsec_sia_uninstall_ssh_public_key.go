...
type IdsecSIAUninstallSSHPublicKey struct {
	TargetMachine      string `json:"target_machine" mapstructure:"target_machine" flag:"target-machine" desc:"Target machine on which to uninstall the ssh public key on"`
