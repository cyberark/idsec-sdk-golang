...
type IdsecSIASettingsSshCommandAudit struct {
	IsCommandParsingForAuditEnabled *bool   `json:"is_command_parsing_for_audit_enabled,omitempty" mapstructure:"is_command_parsing_for_audit_enabled,omitempty" flag:"is-command-parsing-for-audit-enabled" desc:"Indicates whether command parsing for audit is enabled."`
