...
type IdsecSIASettingsLogonSequence struct {
	AlwaysUseSia  *bool   `json:"always_use_sia,omitempty" mapstructure:"always_use_sia,omitempty" flag:"always-use-sia" desc:"Whether to always use SIA for logon sequence"`
	LogonSequence *string `json:"logon_sequence,omitempty" mapstructure:"logon_sequence,omitempty" flag:"logon-sequence" desc:"Configuration for the tenant logon sequence"`
}
