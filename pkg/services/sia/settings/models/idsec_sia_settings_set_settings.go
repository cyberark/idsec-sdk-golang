...
type IdsecSIASettingsSetSettings struct {
	...
	ValidateFingerprintForSSHZeroStanding *IdsecSIASettingsValidateFingerprintForSSHZeroStanding `json:"validate_fingerprint_for_ssh_zero_standing,omitempty" mapstructure:"validate_fingerprint_for_ssh_zero_standing,omitempty" flag:"validate-fingerprint-for-ssh-zero-standing" desc:"SSH fingerprint validation for Zero Standing connections"`
	...
	HTTPSRelay                            *IdsecSIASettingsHTTPSRelay                            `json:"https_relay,omitempty" mapstructure:"https_relay,omitempty" flag:"https-relay" desc:"The settings for HTTPS Relay."`
	RdpChannels                           *IdsecSIASettingsRdpChannels                           `json:"rdp_channels,omitempty" mapstructure:"rdp_channels,omitempty" flag:"rdp-channels" desc:"The settings for RDP channels."`
}
