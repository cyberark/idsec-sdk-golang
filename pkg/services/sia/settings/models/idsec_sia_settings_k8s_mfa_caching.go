...
type IdsecSIASettingsK8sMfaCaching struct {
	KeyExpirationTimeSec *int  `json:"key_expiration_time_sec,omitempty" mapstructure:"key_expiration_time_sec,omitempty" flag:"key-expiration-time-sec" desc:"The expiration time (in seconds) for the MFA caching key." default:"7200"`
	ClientIPEnforced     *bool `json:"client_ip_enforced,omitempty" mapstructure:"client_ip_enforced,omitempty" flag:"client-ip-enforced" desc:"Indicates whether client IP is enforced for MFA caching." default:"true"`
}
