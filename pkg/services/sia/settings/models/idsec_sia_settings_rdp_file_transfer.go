...
type IdsecSIASettingsRdpFileTransfer struct {
	Enabled *bool `json:"enabled,omitempty" mapstructure:"enabled,omitempty" flag:"enabled" desc:"Indicates whether RDP file transfer is enabled for HTML5GW connections via PSM."`
}
