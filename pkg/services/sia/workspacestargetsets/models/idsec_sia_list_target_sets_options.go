...
type IdsecSIAListTargetSetsOptions struct {
	...
	B64StartKey *string `json:"b64_start_key,omitempty" mapstructure:"b64_start_key,omitempty" desc:"The pagination token from the previous response for retrieving the next page."`

	// Name is a wildcard pattern to filter target sets by name on the server side.
	Name *string `json:"name,omitempty" mapstructure:"name,omitempty" desc:"The wildcard pattern to filter the target sets by name, for example, 'prod-*'."`

	// StrongAccountID filters target sets by their associated strong account ID.
	StrongAccountID *string `json:"strong_account_id,omitempty" mapstructure:"strong_account_id,omitempty" desc:"The associated strong account ID by which to filter the target sets."`
}
