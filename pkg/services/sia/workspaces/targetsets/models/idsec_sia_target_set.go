...
type IdsecSIATargetSet struct {
	...
	ProvisionFormat             string `json:"provision_format,omitempty" mapstructure:"provision_format,omitempty" flag:"provision-format" desc:"The provisioning format for the target set ephemeral users."`
	...
	SecretType                  string `json:"secret_type,omitempty" mapstructure:"secret_type,omitempty" flag:"secret-type" desc:"The Secret type of the target set." choices:"ProvisionerUser,PCloudAccount"`
	...
	Type                        string `json:"type" mapstructure:"type" flag:"type" desc:"The type of the target set." validate:"required" choices:"Domain,Suffix,Target"`
}
