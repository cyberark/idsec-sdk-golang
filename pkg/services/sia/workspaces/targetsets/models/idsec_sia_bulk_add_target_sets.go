...
type IdsecSIABulkAddTargetSetsItem struct {
	StrongAccountID string               `json:"strong_account_id" mapstructure:"strong_account_id" flag:"strong-account-id" desc:"The Secret ID of the strong account related to the target set." validate:"required"`
...
type IdsecSIABulkAddTargetSets struct {
	TargetSetsMapping []IdsecSIABulkAddTargetSetsItem `json:"target_sets_mapping" mapstructure:"target_sets_mapping" flag:"target-sets-mapping" desc:"The bulk of target set mappings to add." validate:"required,dive"`
}
