...
type IdsecSIATargetSetsCountOptions struct {
	...
	B64StartKey *string `json:"b64_start_key,omitempty" mapstructure:"b64_start_key,omitempty" desc:"Pagination token (typically not needed for count queries)"`

	// Name is a wildcard pattern to filter target sets by name before counting.
	Name *string `json:"name,omitempty" mapstructure:"name,omitempty" desc:"Wildcard pattern to filter target sets by name before counting (e.g., 'prod-*')"`

	// StrongAccountID filters target sets by their associated strong account ID before counting.
	StrongAccountID *string `json:"strong_account_id,omitempty" mapstructure:"strong_account_id,omitempty" desc:"Filter by associated strong account ID before counting"`
}
