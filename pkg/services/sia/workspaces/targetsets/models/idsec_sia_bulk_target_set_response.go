...
type IdsecSIABulkTargetSetResponse struct {
	Results []IdsecSIABulkTargetSetItemResult `json:"results" mapstructure:"results" flag:"results" desc:"List of results for the target set bulk operation" validate:"required,dive"`
}
