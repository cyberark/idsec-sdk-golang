...
type IdsecPolicyEntitlement struct {
	TargetCategory string `json:"target_category" validate:"required" mapstructure:"target_category" flag:"target-category" desc:"The category of the target: Cloud access: Cloud console, Groups; Infrastructure access: VM, DB; Kubernetes: Clusters" choices:"Cloud console,VM,DB,Groups,Clusters"`
