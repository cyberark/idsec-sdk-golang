...
type IdsecPolicyStatus struct {
	Status            string `json:"status" mapstructure:"status" flag:"status" desc:"The status of the policy" choices:"Active,Suspended,Expired,Validating,Error,Warning" default:"Active"`
