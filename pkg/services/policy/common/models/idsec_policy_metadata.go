...
type IdsecPolicyMetadata struct {
	...
	Status            *IdsecPolicyStatus     `json:"status,omitempty" mapstructure:"status,omitempty" flag:"status" desc:"The status of the policy"`
...
// GetStatusString safely returns the status string from the nested Status pointer.
// Returns an empty string if Status is nil.
func (metadata *IdsecPolicyMetadata) GetStatusString() string {
