...
type IdsecPolicyTimeCondition struct {
	...
	FromHour      string `json:"from_hour,omitempty" mapstructure:"from_hour,omitempty" flag:"from-hour" desc:"The start time of the policy's access window" validate:"regexp=^\\d{2}:\\d{2}:\\d{2}$" default:""`
	ToHour        string `json:"to_hour,omitempty" mapstructure:"to_hour,omitempty" flag:"to-hour" desc:"The end time of the policy's access window" validate:"regexp=^\\d{2}:\\d{2}:\\d{2}$" default:""`
}
