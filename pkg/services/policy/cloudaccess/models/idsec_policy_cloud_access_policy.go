...
type IdsecPolicyCloudAccessCloudConsoleAccessPolicy struct {
	...
	Conditions                                       IdsecPolicyCloudAccessConditions            `json:"conditions" mapstructure:"conditions" flag:"conditions" desc:"The allowed session length, and the access window (days and times) during which a session can be started."`
