...
// IdsecPamshAccountSecretManagement represents the secret management properties of an account.
type IdsecPamshAccountSecretManagement struct {
...
// IdsecPamshAccount represents the full properties of an account.
type IdsecPamshAccount struct {
	...
	AccountID                 string                             `json:"id" mapstructure:"id" desc:"The unique ID of the account" flag:"account-id" validate:"required"`
	...
	Username                  string                             `json:"username,omitempty" mapstructure:"user_name,omitempty" desc:"The account username" flag:"username"`
