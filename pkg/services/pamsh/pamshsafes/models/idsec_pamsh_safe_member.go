...
// IdsecPamshSafeMemberPermissions represents the permissions of a safe member.
type IdsecPamshSafeMemberPermissions struct {
...
// IdsecPamshSafeMember represents a safe member with its details and permissions.
type IdsecPamshSafeMember struct {
	...
	Permissions                IdsecPamshSafeMemberPermissions `json:"permissions" mapstructure:"permissions" desc:"The permissions that the user or group has on this Safe"`
	PermissionSet              string                          `json:"permission_set" mapstructure:"permission_set" desc:"Permission set type the permissions are set to (connect_only,read_only,approver,accounts_manager,full,custom)" default:"read_only" choices:"connect_only,read_only,approver,accounts_manager,full,custom"`
}
