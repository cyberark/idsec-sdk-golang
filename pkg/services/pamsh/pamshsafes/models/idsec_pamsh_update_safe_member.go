...
// IdsecPamshUpdateSafeMember represents the details required to update a safe member.
type IdsecPamshUpdateSafeMember struct {
	...
	Permissions              *IdsecPamshSafeMemberPermissions `json:"permissions,omitempty" mapstructure:"permissions,omitempty" desc:"User or group permissions in the Safe to be updated" flag:"permissions"`
