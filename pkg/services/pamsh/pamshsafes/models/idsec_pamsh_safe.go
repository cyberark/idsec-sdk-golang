...
// IdsecPamshSafeCreator represents the creator of a safe.
type IdsecPamshSafeCreator struct {
...
// IdsecPamshSafe represents a safe with additional details.
type IdsecPamshSafe struct {
	...
	Creator                   IdsecPamshSafeCreator `json:"creator,omitempty" mapstructure:"creator" desc:"Name/ID of the user that created the Safe" flag:"creator"`
