...
// IdsecPamshAddSafeMember represents the details required to add a safe member.
type IdsecPamshAddSafeMember struct {
	...
	Permissions              *IdsecPamshSafeMemberPermissions `json:"permissions,omitempty" mapstructure:"permissions,omitempty" desc:"The permissions that the user or group has on this Safe"`
