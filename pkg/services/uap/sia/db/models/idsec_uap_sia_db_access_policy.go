...
type IdsecUAPSIADBAccessPolicy struct {
	...
	Targets                         map[string]IdsecUAPSIADBTargets `json:"targets,omitempty" mapstructure:"targets,omitempty" flag:"targets" desc:"The targets of the database access policy." choices:"FQDN/IP"`
}
