...
In this example we authenticate to our ISP tenant and list available access assets:
```go
package main
...
func main() {
	...
	// Create an Access Assets service and list assets
	...
	// Retrieve a secret for a specific asset
	...
	fmt.Printf("Secret for asset %s retrieved\n", secretResponse.AssetID)
}
```
